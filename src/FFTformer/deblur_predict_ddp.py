...
from FFTformer.models.FFTformerBlurDM import fftformer_prior
from FFTformer.models.LatentBlurDM import LatentExposureDiffusion
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir_path", default='./results/FFTformer/GoPro', type=str)
    parser.add_argument("--model_path", default="./weights/FFTformer/GoPro/FFTformer_GoPro_stage3.pth", type=str)
    parser.add_argument("--model_dm_path", default="./weights/FFTformer/GoPro/FFTformer_GoPro_stage3.pth", type=str)
    parser.add_argument("--model", default='FFTformer', type=str, choices=['FFTformer'])
