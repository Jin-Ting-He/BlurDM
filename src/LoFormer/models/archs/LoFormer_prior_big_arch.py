...
class LoFormerPriorBig(nn.Module):
    def __init__(self,
                 inp_channels=3,
                 out_channels=3,
                 dim=36,
        ...
        super(LoFormerPriorBig, self).__init__()
...
if __name__ == '__main__':
    ...
    model = LoFormerPriorBig().eval().cuda()
    with torch.no_grad():
...
#     net = LoFormerPriorBig(dim=dim, enc_blk_nums=enc_blk_nums, middle_blk_num=middle_blk_num,dec_blk_nums=dec_blk_nums,
